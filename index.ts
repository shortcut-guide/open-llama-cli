...
async function loadHistory(systemPrompt: string): Promise<Message[]> {
  try {
...
function extractFileBlocks(message: string): { filePath: string; content: string }[] {
...
async function sanityCheckWrite(
  filePath: string,
