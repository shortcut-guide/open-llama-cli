...
<!-- For checkpoint task examples and patterns, see @/Users/higemaru/open-llama-cli/.gemini/get-shit-done/references/checkpoints.md -->
...
See `/Users/higemaru/open-llama-cli/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/higemaru/open-llama-cli/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/higemaru/open-llama-cli/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
