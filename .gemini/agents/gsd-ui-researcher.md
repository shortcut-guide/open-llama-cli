...
Use template from `/Users/higemaru/open-llama-cli/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/higemaru/open-llama-cli/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/higemaru/open-llama-cli/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
