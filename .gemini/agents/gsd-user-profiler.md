...
<reference>
@/Users/higemaru/open-llama-cli/.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/higemaru/open-llama-cli/.gemini/get-shit-done/references/user-profiling.md` to load:
