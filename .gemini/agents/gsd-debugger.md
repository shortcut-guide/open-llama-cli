...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/higemaru/open-llama-cli/.gemini
                  → checks /Users/higemaru/open-llama-cli/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/higemaru/open-llama-cli/.gemini/get-shit-done
                  → writes to /Users/higemaru/open-llama-cli/.gemini/get-shit-done/hooks/
...
@/Users/higemaru/open-llama-cli/.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/higemaru/open-llama-cli/.gemini/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/higemaru/open-llama-cli/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/higemaru/open-llama-cli/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/higemaru/open-llama-cli/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
