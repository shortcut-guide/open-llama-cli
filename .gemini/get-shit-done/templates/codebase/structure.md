...
- Usage: Reference from command with `@/Users/higemaru/open-llama-cli/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/higemaru/open-llama-cli/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/higemaru/open-llama-cli/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
